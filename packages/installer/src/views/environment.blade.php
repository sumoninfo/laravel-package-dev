...
@section('style')
    <link href="{{ asset('assets/froiden-helper/helper.css') }}" rel="stylesheet"/>
    <style>
        .form-control{
            height: 14px;
            width: 100%;
...
@endsection
@section('container')
    <form method="post" action="{{ route('environmentSave') }}" id="env-form">
...
@section('scripts')
    ...
    <script src="{{ asset('assets/froiden-helper/helper.js')}}"></script>
    <script>
        $.ajaxSetup({
            headers: {
